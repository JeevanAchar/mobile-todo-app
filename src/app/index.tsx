...
export default function HomeScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      {/* Header */}
      <View className="flex flex-col items-center justify-end bg-[#62D2C3] relative" style={{ height: height * 0.16 }}>
        <Image source={require("../assests/RoundHeaderImage.png")} className="absolute -top-5 left-0" />
      ...
      <View className="flex flex-col" style={{ height: height * 0.84 }}>
        ...
        <View className="p-4 w-full flex-row items-center gap-2">
          <TextInput className="outline-none p-3 px-4 text-base font-semibold text-gray-500
          active:ring-2 active:ring-[#62D2C3] rounded-lg border border-gray-300 flex-1"
            value={inputValue} onChangeText={setInputValue} placeholder="Enter a new todo..." />
        ...
        {/* Todo List Section */}
        {todos.length > 0 && <Text className="px-5 text-[24px] font-semibold text-gray-500 underline mb-3">Todo's</Text>}
        {/* Todo List */}
        <FlatList
